          ...
          <div className="md:max-w-md w-full px-4 py-4">
            <form>
              <div className="mb-12">
                ...
                <p className="text-sm mt-4 text-gray-800">Don't have an account <NavLink to="/bt4/register" className="text-[#F97D00] font-semibold hover:underline ml-1 whitespace-nowrap">Register here</NavLink></p>
              </div>
              <div>
                <label className="text-gray-800 text-xs block mb-2">Email</label>
                <div className="relative flex items-center">
                  <input name="email" type="text" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-[#F97D00] px-2 py-3 outline-none" placeholder="Enter email" />
              ...
              <div className="mt-8">
                ...
                <div className="relative flex items-center">
                  <input name="password" type="password" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-[#F97D00] px-2 py-3 outline-none" placeholder="Enter password" />
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
                <div className="flex items-center">
                  <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 shrink-0 text-[#F97D00] focus:ring-blue-500 border-gray-300 rounded" />
                  <label htmlFor="remember-me" className="ml-3 block text-sm text-gray-800">
                    Remember me
                  </label>
                </div>
                <div>
                  <a href="jajvascript:void(0);" className="text-[#F97D00] font-semibold text-sm hover:underline">
                    Forgot Password?
                  </a>
                </div>
              </div>
              <div className="mt-12">
                <button type="button" className="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-[#F97D00] hover:bg-[#f97c00dd] focus:outline-none">
                  Sign in
                </button>
              </div>
