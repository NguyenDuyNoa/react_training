        ...
        <form className="bg-white max-w-xl w-full mx-auto shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-8 rounded-2xl">
          ...
          <div>
            ...
            <div className="relative flex items-center">
              <input name="name" type="text" required className="w-full bg-transparent text-sm text-gray-800 border-b border-gray-300 focus:border-[#F97D00] px-2 py-3 outline-none" placeholder="Enter name" />
          ...
          <div className="mt-8">
            ...
            <div className="relative flex items-center">
              <input name="email" type="text" required className="w-full bg-transparent text-sm text-gray-800 border-b border-gray-300 focus:border-[#F97D00] px-2 py-3 outline-none" placeholder="Enter email" />
          ...
          <div className="mt-8">
            ...
            <div className="relative flex items-center">
              <input name="password" type="password" required className="w-full bg-transparent text-sm text-gray-800 border-b border-gray-300 focus:border-[#F97D00] px-2 py-3 outline-none" placeholder="Enter password" />
          ...
          <div className="mt-8">
            <button type="button" className="w-full shadow-xl py-2.5 px-5 text-sm font-semibold tracking-wider rounded-md text-white bg-[#F97D00] hover:bg-[#f97c00e1] focus:outline-none transition-all">
              Register
            </button>
            <p className="text-gray-800 text-sm mt-8 text-center">Already have an account? <NavLink to="/bt4/login" className="text-[#F97D00] font-semibold hover:underline ml-1">Login here</NavLink></p>
          </div>
        </form>
      </div>
    </div>
